...
public class frame extends JFrame implements ActionListener { 
  ...
  JPanel validWordPanel = new JPanel();
...
public frame() {
  ...
  //Valid Word
  validWordPanel.setLayout(new BoxLayout(validWordPanel, BoxLayout.PAGE_AXIS));

  validWord.setFont(font);

  validWord.setAlignmentX(CENTER_ALIGNMENT);

  validWordPanel.add(validWord);
  validWordPanel.setBorder(upperBorder);
  ...
  if (playerNum == 2) {
    ...
    validWordPanel.setPreferredSize(new Dimension(257, 65));
