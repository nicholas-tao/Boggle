  ...
  public static void setupQuestions() {
	    ...
	    do {
	      ...
	      try {
	    	    ...
	    	    JOptionPane.showMessageDialog(null, "You have to an appropriate value", "alert", JOptionPane.ERROR_MESSAGE);
	    	    continue;
	      }
	    ...
	    if (playerNum == 1) {
    		do {
    			 String input = JOptionPane.showInputDialog(null, "Enter time (secs) available for input", "Enter name");
    		      ...
    		      if (onePlayerTimeInterval < 5) {
    		        JOptionPane.showMessageDialog(null, "You have to enter a value bigger than 5", "alert", JOptionPane.ERROR_MESSAGE);
    		      }
